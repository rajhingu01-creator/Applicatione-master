...
const ProfileScreen = ({ navigation, route }) => {
  ...
  const [postScheduledTime, setPostScheduledTime] = useState(new Date());
  ...
  useEffect(() => {
    if (route?.params?.openCreatePost) {
      ...
      navigation.setParams({ openCreatePost: false });
    }
  }, [navigation, route?.params?.openCreatePost]);
  ...
  const uploadImage = async (uri) => {
    ...
    try {
      ...
      Alert.alert(
        "Network Error",
        `Error uploading image. Check if server is running at ${BASE_URL}`,
      );
    } finally {
      setIsLoading(false);
    }
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeAreaHeader}>
        <View style={styles.headerBar}>
          ...
          {isEditing ? (
            ...
            >
              <Text
                style={[styles.saveHeaderText, isLoading && { opacity: 0.5 }]}
              >
                {isLoading ? "..." : "Save"}
              </Text>
            </TouchableOpacity>
            ...
            <View style={styles.editForm}>
              <View style={styles.editCard}>
                ...
                >
                  ...
                  >
                    <Text style={styles.saveButtonTextFull}>
                ...
                >
                  <View style={styles.bannerAvatarWrapper}>
                    <View style={styles.bannerAvatarBorder}>
                      <Image
                        source={{
                          uri: isEditing ? editData.avatar : profileData.avatar,
                        }}
                  ...
                  <View style={styles.bannerTextContainer}>
                    ...
                    <Text style={styles.bannerSubtext}>
                      A clean, unique creator profile.
                    </Text>
                  </View>
                </LinearGradient>
              </View>
            ...
            <View style={styles.statsCardRow}>
              ...
              <View style={styles.circleStatCard}>
                <View style={[styles.circleContainer, { borderColor: "#ddd" }]}>
                  <View
                    style={[styles.circleProgress, { borderColor: "#4ECDC4" }]}
                  />
                  <View
                    style={[
                      styles.circleDot,
                      { backgroundColor: "#4ECDC4", top: 4, right: 4 },
                    ]}
                  />
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  navigation.navigate("Followers", { initialTab: "Followers" })
                }
                activeOpacity={0.7}
              >
                <View style={[styles.circleContainer, { borderColor: "#ddd" }]}>
                  <View
                    style={[styles.circleProgress, { borderColor: "#45B7A8" }]}
                  />
                  <View
                    style={[
                      styles.circleDot,
                      { backgroundColor: "#45B7A8", top: 16, left: 4 },
                    ]}
                  />
                  <View
                    style={[
                      styles.circleDot,
                      { backgroundColor: "#45B7A8", bottom: 4, right: 16 },
                    ]}
                  />
              ...
              <TouchableOpacity
                style={styles.circleStatCard}
                onPress={() =>
                  navigation.navigate("Followers", { initialTab: "Following" })
                }
                activeOpacity={0.7}
              >
                <View style={[styles.circleContainer, { borderColor: "#ddd" }]}>
                  <View
                    style={[styles.circleProgress, { borderColor: "#FFA07A" }]}
                  />
                  <View
                    style={[
                      styles.circleDot,
                      { backgroundColor: "#FFA07A", bottom: 8, left: 8 },
                    ]}
                  />
                  <Text style={styles.circleNumber}>
          ...
          <View style={styles.actionButtonsRowCompact}>
            ...
            {!isEditing && (
              <>
                ...
                >
                  <Briefcase size={18} color="#008000" />
                  <Text style={styles.jobActionText}>Job</Text>
                </TouchableOpacity>
              </>
            )}
          </View>
        ...
        <SafeAreaView style={styles.previewContainer}>
          ...
          <View style={styles.previewFooter}>
            <Text style={styles.previewHint}>
              This photo will be visible to everyone on your profile.
            </Text>
      ...
      >
        <SafeAreaView style={styles.previewContainer}>
          ...
          <View style={styles.previewFooter}>
            <Text style={styles.previewHint}>
              This image will be used for your post in 4:5 aspect ratio.
            </Text>
            ...
            >
              <LinearGradient
                ...
                style={styles.confirmGradient}
              >
                <Text style={styles.confirmBtnText}>OK / Save</Text>
              </LinearGradient>
            </TouchableOpacity>
      ...
      >
        <SafeAreaView style={styles.createPostContainer}>
          <View style={styles.createPostHeader}>
            ...
            <TouchableOpacity
              onPress={() => setShowPostDropdown(true)}
              disabled={isPosting}
            >
              <Text
                style={[styles.createPostText, isPosting && { opacity: 0.5 }]}
              >
                Post
              </Text>
            </TouchableOpacity>
          ...
          {showPostDropdown && (
            <TouchableOpacity
              ...
              activeOpacity={1}
            >
              <View style={styles.postDropdownContainer}>
                <TouchableOpacity
                    ...
                    try {
                      ...
                      const response = await fetch(`${API_URL}/profile/posts`, {
                        ...
                        body: JSON.stringify({
                              ...
                              isScheduled: true,
                              scheduledAt: postScheduledTime.toISOString()
                            }),
                      });
                      const data = await response.json();
                ...
                >
                  <Text style={styles.postDropdownItemText}>Instant Post</Text>
                </TouchableOpacity>

                <View style={styles.postDropdownDivider} />
                ...
                >
                  <Text style={styles.postDropdownItemText}>Schedule Post</Text>
                  {isPostScheduled && (
                    <CheckCircle size={20} color="#008000" />
                  )}
                </TouchableOpacity>

                {isPostScheduled && (
                  <>
                    <View style={styles.dropdownScheduleSection}>
                    <View style={styles.scheduleRow}>
                      <Text style={styles.scheduleLabel}>Date</Text>
                      <TouchableOpacity style={styles.scheduleInputBox}>
                        <Text style={styles.scheduleInputText}>
                          {postScheduledTime.toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
                        </Text>
                      </TouchableOpacity>
                    </View>
                      ...
                      <View style={styles.scheduleTimeBox}>
                        ...
                        <View style={styles.timeControlContainer}>
                          <TouchableOpacity
                            ...
                            onPress={() => {
                              const newDate = new Date(postScheduledTime);
                              newDate.setHours((newDate.getHours() - 1 + 24) % 24);
                              setPostScheduledTime(newDate);
                            }}
                          >
                            <Text style={styles.timeControlBtnText}>▲</Text>
                          </TouchableOpacity>
                          <Text style={styles.timeControlValue}>
                            {String(postScheduledTime.getHours()).padStart(2, '0')}
                          </Text>
                          <TouchableOpacity
                            style={styles.timeControlBtn}
                            onPress={() => {
                        ...
                        <View style={styles.timeControlContainer}>
                          ...
                          <Text style={styles.timeControlValue}>
                            {String(postScheduledTime.getMinutes()).padStart(2, '0')}
                          </Text>
                          <TouchableOpacity
                            style={styles.timeControlBtn}
                            onPress={() => {
                    ...
                    <TouchableOpacity
                      style={styles.dropdownScheduleBtn}
                      onPress={async () => {
                        if (!postImage) {
                          Alert.alert("Error", "Please select an image");
                          return;
                        ...
                        try {
                          ...
                          if (data.success) {
                            ...
                            Alert.alert(
                              "Error",
                              data.message || "Failed to schedule post",
                            );
                          }
                        } catch (error) {
                    ...
                    >
                      <LinearGradient
                        colors={["#FF8C00", "#008000"]}
                        style={styles.dropdownScheduleBtnGradient}
                      >
                        <Text style={styles.dropdownScheduleBtnText}>
                          {isPosting ? "Scheduling..." : "Schedule Now"}
                        </Text>
                      </LinearGradient>
                    </TouchableOpacity>
                  </>
...
const styles = StyleSheet.create({
  ...
  dropdownScheduleBtnGradient: {
    paddingVertical: 12,
    alignItems: 'center',
  },
  dropdownScheduleBtnText: {
    color: '#FFFFFF',
    fontSize: 15,
    fontWeight: '700',
  },
