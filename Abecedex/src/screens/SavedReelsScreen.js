...
const initialCollections = [
  { id: 'all', name: 'All', count: 0, icon: Grid },
];
...
const SavedReelsScreen = ({ navigation }) => {
  ...
  const filteredReels = activeCollection === 'All'
    ? savedReels
  ...
  return (
    <SettingsShell navigation={navigation} title="Saved Reels">
      <View style={styles.searchRow}>
        ...
        <TouchableOpacity activeOpacity={0.84} onPress={() => setModalVisible(true)} style={styles.addMiniButton}>
      ...
      <View style={styles.collectionHeader}>
        ...
        <TouchableOpacity activeOpacity={0.78} onPress={() => setModalVisible(true)} style={styles.createLink}>
        ...
        {collections.map((collection) => {
          ...
          return (
            ...
            >
              ...
              <Text style={[styles.collectionName, active && styles.collectionNameActive]}>{collection.name}</Text>
              <Text style={[styles.collectionCount, active && styles.collectionCountActive]}>{collection.count}</Text>
            </TouchableOpacity>
          );
        })}
      </View>
      ...
      <View style={[styles.grid, { gap }]}>
        {filteredReels.length > 0 ? (
          filteredReels.map((reel) => (
            <TouchableOpacity key={reel.id} activeOpacity={0.86} style={[styles.reelCard, { width: cardWidth, height: cardHeight }]}>
              ...
              <View style={styles.reelBottom}>
                <Text numberOfLines={1} style={styles.reelTitle}>{reel.title}</Text>
                <Text numberOfLines={1} style={styles.reelCreator}>{reel.creator}</Text>
          ...
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtitle}>Reels you save will appear here. Start exploring and save your favorites!</Text>
            <TouchableOpacity 
              activeOpacity={0.84}
        ...
        <View style={styles.modalBackdrop}>
          <View style={styles.modalCard}>
            <View style={styles.modalHeader}>
              ...
              <TouchableOpacity activeOpacity={0.75} onPress={() => setModalVisible(false)} style={styles.closeButton}>
                <X size={20} color="#111" />
              </TouchableOpacity>
            </View>
            <Text style={styles.modalTitle}>Create collection</Text>
            <Text style={styles.modalText}>Name a folder so saved reels stay organized by mood, topic or campaign.</Text>
            <TextInput
            ...
            <TouchableOpacity activeOpacity={0.84} onPress={addCollection}>
              <LinearGradient colors={['#F5A400', '#008000']} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.createButton}>
