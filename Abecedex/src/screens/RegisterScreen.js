      ...
      >
        ...
        >
          ...
          <View style={[styles.logoSection, compact && styles.logoSectionCompact]}>
            ...
            <Text style={styles.subtitleText}>Join Changis and start your journey.</Text>
          </View>
          ...
          <View style={styles.formSection}>
            ...
            <Text style={styles.fieldInfo}>This will be your unique username</Text>
            ...
            <View style={styles.inputWrapper}>
              ...
              <TouchableOpacity onPress={() => setShowPassword(!showPassword)}>
                {showPassword ? <EyeOff size={16} color="#999" /> : <Eye size={16} color="#999" />}
              </TouchableOpacity>
            </View>
            <Text style={styles.fieldInfo}>At least 8 characters with letters and numbers</Text>
            ...
            <View style={styles.inputWrapper}>
              ...
              <TouchableOpacity onPress={() => setShowConfirmPassword(!showConfirmPassword)}>
                {showConfirmPassword ? <EyeOff size={16} color="#999" /> : <Eye size={16} color="#999" />}
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.socialButtons}>
              ...
              <TouchableOpacity style={styles.socialButton}>
                <View style={styles.socialButtonContent}>
                  <FontAwesome name="apple" size={16} color="#000" style={styles.socialIcon} />
                  <Text style={styles.socialButtonText}>Continue with Apple</Text>
                </View>
              </TouchableOpacity>
              <TouchableOpacity style={styles.socialButton}>
                <View style={styles.socialButtonContent}>
                  <FontAwesome name="facebook" size={16} color="#4267B2" style={styles.socialIcon} />
