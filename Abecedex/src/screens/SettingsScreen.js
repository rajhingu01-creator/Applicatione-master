...
const quickControls = [
  { id: 'privacy', title: 'Privacy', value: 'Tight', icon: Lock, tone: ['#008000', '#19C35A'] },
  { id: 'alerts', title: 'Alerts', value: 'Smart', icon: Bell, tone: ['#F5A400', '#FFCB4D'] },
  { id: 'media', title: 'Media', value: 'HD', icon: ImageUp, tone: ['#111', '#444'] },
];
...
const settingGroups = [
  {
    ...
    title: 'Identity',
    items: [
      { id: 'account', title: 'Account Center', icon: User, route: 'AccountSettings' },
      { id: 'security', title: 'Security & Login', icon: Lock, route: 'Security' },
      { id: 'visibility', title: 'Visibility', icon: Eye, route: 'AccountVisibility' },
    ]
  },
  {
    title: 'Interaction',
    items: [
      { id: 'notifications', title: 'Notifications', icon: Bell, route: 'NotificationSettings' },
      { id: 'messages', title: 'Messages & Replies', icon: MessageSquare, route: 'ChatList' },
      { id: 'blocked', title: 'Blocked Accounts', icon: User, route: 'BlockedUsers' },
    ]
  },
  {
    title: 'Experience',
    items: [
      { id: 'theme', title: 'Theme & Palette', icon: Palette },
      { id: 'saved', title: 'Saved Content', icon: Bookmark, route: 'SavedReels' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'safety', title: 'Safety Center', icon: Shield },
      { id: 'about', title: 'About', icon: Info, route: 'About' },
    ]
  }
];
...
const SettingsScreen = ({ navigation }) => {
  ...
  const tileWidth = (width - screen * 2 - 18) / 3;

  const renderQuickControl = (item) => {
    const Icon = item.icon;
    return (
      <TouchableOpacity key={item.id} activeOpacity={0.84} style={[styles.quickTile, { width: tileWidth }]}>
        ...
        <Text numberOfLines={1} style={styles.quickValue}>{item.value}</Text>
      </TouchableOpacity>
    );
  };
  ...
  const renderSettingItem = (item, index, groupLength) => {
    ...
    return (
      <TouchableOpacity
        key={item.id}
        activeOpacity={0.78}
        style={[styles.settingItem, index === groupLength - 1 && styles.settingItemLast]}
  ...
  return (
    <View style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <LinearGradient colors={['#FFF7E7', '#F6FFF7']} style={styles.heroPanel}>
            <View style={styles.heroTop}>
              ...
              <View style={styles.heroCopy}>
                <Text numberOfLines={1} style={styles.profileName}>Sam Brown</Text>
                <Text numberOfLines={1} style={styles.profileHandle}>@sam_perry</Text>
              </View>
            ...
            <View style={styles.heroBottom}>
              <View>
                ...
                <Text style={[styles.heroTitle, compact && styles.heroTitleCompact]}>Your profile is tuned for reach</Text>
              </View>
          ...
          <View style={styles.insightStrip}>
            ...
            <View style={styles.insightCopy}>
              ...
              <Text numberOfLines={1} style={styles.insightText}>Privacy, media quality and alerts are balanced.</Text>
            </View>
          </View>
